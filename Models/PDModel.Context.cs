...
namespace Pricing.Models
{
    ...
    public partial class NORTHWNDEntities2 : DbContext
    {
        ...
        [DbFunction("NORTHWNDEntities2", "Split")]
        public virtual IQueryable<Split_Result> Split(string @string)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Split_Result>("[NORTHWNDEntities2].[Split](@String)", stringParameter);
        }
        ...
        public virtual ObjectResult<FilterBoreHole_Result> FilterBoreHole(string wellName, string boreHoleName, string status, string @class)
        {
            var wellNameParameter = wellName != null ?
                new ObjectParameter("WellName", wellName) :
                new ObjectParameter("WellName", typeof(string));
    
            var boreHoleNameParameter = boreHoleName != null ?
                new ObjectParameter("BoreHoleName", boreHoleName) :
                new ObjectParameter("BoreHoleName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<FilterBoreHole_Result>("FilterBoreHole", wellNameParameter, boreHoleNameParameter, statusParameter, classParameter);
        }
